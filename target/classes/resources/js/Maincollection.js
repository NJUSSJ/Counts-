...
function setCollection(){
    ...
    for(var i=0;i<rowNum;i++){
        ...
        a3_2.href="/details.html?imageURL="+missionNames[i*3+2].substring(0,missionNames[rowNum*3+i].indexOf("^"))+"&userPhone="+userPhone1+"&userCategory="+userCategory1+"&Tagable=0";
